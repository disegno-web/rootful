<?php
/**
 * rootful Customizer Custom Controls
 *
 */
...
if ( class_exists( 'WP_Customize_Control' ) ) {
	 ...
	 */
	 class Rootful_Image_Checkbox_Custom_Control extends WP_Customize_Control {
 		/**
 		 ...
 		 */
  		public function enqueue() {
 			wp_enqueue_style( 'rootful-custom-controls-css', trailingslashit( get_template_directory_uri() ) . 'inc/customizer/customizer-controls/custom-controls-styles.css', array(), '1.0', 'all' );
  		}
 		/**
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	 class Rootful_Text_Radio_Button_Custom_Control extends WP_Customize_Control {
 		/**
 		 * The type of control being rendered
 		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Rootful_Image_Radio_Button_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Rootful_Single_Accordion_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'rootful-custom-controls-js', trailingslashit( get_template_directory_uri() ) . 'inc/customizer/customizer-controls/custom-controls.js', array( 'jquery', 'jquery-ui-core' ), '1.0', true );
			wp_enqueue_style( 'rootful-custom-controls-css', trailingslashit( get_template_directory_uri() ) . 'inc/customizer/customizer-controls/custom-controls-styles.css', array(), '1.0', 'all' );
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Rootful_Simple_Notice_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class rootful_Slider_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Rootful_Toggle_Switch_Custom_control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Rootful_Sortable_Repeater_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function enqueue() {
			wp_enqueue_script( 'rootful-custom-controls-js', trailingslashit( get_template_directory_uri() ) . 'inc/customizer/customizer-controls/custom-controls.js', array( 'jquery', 'jquery-ui-core' ), '1.0', true );
			wp_enqueue_style( 'rootful-custom-controls-css', trailingslashit( get_template_directory_uri() ) . 'css/customizer.css', array(), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Rootful_Dropdown_Select2_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Rootful_Dropdown_Posts_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Rootful_TinyMCE_Custom_control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function to_json() {
			parent::to_json();
			$this->json['rootfultinymcetoolbar1'] = isset( $this->input_attrs['toolbar1'] ) ? esc_attr( $this->input_attrs['toolbar1'] ) : 'bold italic bullist numlist alignleft aligncenter alignright link';
			$this->json['rootfultinymcetoolbar2'] = isset( $this->input_attrs['toolbar2'] ) ? esc_attr( $this->input_attrs['toolbar2'] ) : '';
		}
		/**
		 * Render the control in the customizer
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Rootful_Google_Font_Select_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function __construct( $manager, $id, $args = array(), $options = array() ) {
			...
			$this->fontList = $this->rootful_getGoogleFonts( 'all' );
			// Decode the default json font value
			$this->fontValues = json_decode( $this->value() );
			// Find the index of our default font within our list of Google fonts
			$this->fontListIndex = $this->rootful_getFontIndex( $this->fontList, $this->fontValues->font );
		}
		/**
		 * Enqueue our scripts and styles
		 */
		...
		public function to_json() {
			parent::to_json();
			$this->json['rootfulfontslist'] = $this->fontList;
		}
		/**
		 * Render the control in the customizer
		 */
		 ...
		 */
		public function rootful_getFontIndex( $haystack, $needle ) {
		 ...
		 */
		public function rootful_getGoogleFonts( $count = 30 ) {
	...
	/**
 	 ...
 	 */
	class Rootful_Customize_Alpha_Color_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function enqueue() {
			wp_enqueue_script( 'rootful-custom-controls-js', trailingslashit( get_template_directory_uri() ) . 'inc/customizer/customizer-controls/custom-controls.js', array( 'jquery', 'jquery-ui-core' ), '1.0', true );
			wp_enqueue_style( 'rootful-custom-controls-css', trailingslashit( get_template_directory_uri() ) . 'css/customizer.css', array( 'wp-color-picker' ), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
		 */
	 ...
	 */
	if ( ! function_exists( 'rootful_url_sanitization' ) ) {
		function rootful_url_sanitization( $input ) {
	 ...
	 */
	if ( ! function_exists( 'rootful_switch_sanitization' ) ) {
		function rootful_switch_sanitization( $input ) {
			if ( true === $input ) {
				return 1;
			} else {
				return 0;
	 ...
	 * @return integer	Sanitized value
	 */
	if ( ! function_exists( 'rootful_radio_sanitization' ) ) {
		function rootful_radio_sanitization( $input, $setting ) {
	 ...
	 */
	if ( ! function_exists( 'rootful_sanitize_integer' ) ) {
		function rootful_sanitize_integer( $input ) {
			return (int) $input;
		}
	}
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'rootful_text_sanitization' ) ) {
		function rootful_text_sanitization( $input ) {
			if ( strpos( $input, ',' ) !== false) {
				$input = explode( ',', $input );
			}
			if( is_array( $input ) ) {
	 ...
	 */
	if ( ! function_exists( 'rootful_array_sanitization' ) ) {
		function rootful_array_sanitization( $input ) {
			if( is_array( $input ) ) {
				foreach ( $input as $key => $value ) {
					$input[$key] = sanitize_text_field( $value );
				}
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'rootful_hex_rgba_sanitization' ) ) {
		function rootful_hex_rgba_sanitization( $input, $setting ) {
			...
			if ( false === strpos( $input, 'rgba' ) ) {
				...
				$input = 'rgba(' . rootful_in_range( $red, 0, 255 ) . ',' . rootful_in_range( $green, 0, 255 ) . ',' . rootful_in_range( $blue, 0, 255 ) . ',' . rootful_in_range( $alpha, 0, 1 ) . ')';
			}
			return $input;
		}
	}
	 ...
	 */
	if ( ! function_exists( 'rootful_in_range' ) ) {
		function rootful_in_range( $input, $min, $max ){
			if ( $input < $min ) {
				$input = $min;
			}
			if ( $input > $max ) {
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'rootful_google_font_sanitization' ) ) {
		function rootful_google_font_sanitization( $input ) {
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'rootful_date_time_sanitization' ) ) {
		function rootful_date_time_sanitization( $input, $setting ) {
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'rootful_range_sanitization' ) ) {
		function rootful_range_sanitization( $input, $setting ) {
			...
			return rootful_in_range( $number, $min, $max );
		}
	}
