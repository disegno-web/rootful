...
class Login_Designer_Toggle_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_style( 'login-designer-toggle-control-styles', get_template_directory_uri( '/inc/customizer/customizer-controls/toggle/toggle.css' ), false, '1.0.0', 'all' );
		wp_enqueue_script( 'login-designer-toggle-control-scripts', get_template_directory_uri( '/inc/customizer/customizer-controls/toggle/toggle.js' ), array( 'jquery' ), '1.0.0', true );
	}
	/**
